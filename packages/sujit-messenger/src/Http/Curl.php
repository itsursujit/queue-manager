...
namespace Sujit\Messenger\Http;
...
class Curl {
     ...
     * @return CurlResponse
     **/
    function get($url, $vars = array(), $headers = array()) {
        $this->headers = $headers;
        if (!empty($vars)) {
     ...
     * @return CurlResponse
     **/
    function head($url, $vars = array(), $headers = array()) {
        $this->headers = $headers;
     ...
     **/
    function post($url, $vars = array(), $headers = array()) {
        $this->headers = $headers;
     ...
     * @return CurlResponse|boolean
     **/
    function put($url, $vars = array(), $headers = array()) {
        $this->headers = $headers;
